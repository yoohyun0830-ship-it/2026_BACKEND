...
public class Exam1 {
    public static void main(String[] args) {
       ...
       // 예외란? 에러발생 시 고치는게 아니라 흐름 제어 vs if
        ...
        // 6. InputMismatchException : 입력타입 예외 발생
        Scanner scan = new Scanner(System.in);
        try{System.out.println("정수입력: ");
        ...
        }catch(Exception e){ // 다중 catch에서 마지막에 Excaption 사용하여 그외 처리한다
            System.out.println("예외발생: 관리자에게 문의"+e);
        }

        // * try{ 예외발생할코드 }catch(예외클래스명 변수명){ }catch(예외클래스명 변수명){ }finally{ }
        // [5] 예외 던지기(떠넘기기) , *예외반환* : 해당 메소드를 호출한 곳으로 예외 반환
        try{
            method1();
        }catch(Exception e){System.out.println("메소드 예외발생");}


    }  
    public static void method1( ) throws ClassNotFoundException {
        Class.forName("java.lang.Spring");
    }
}
