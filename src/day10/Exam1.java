...
public class Exam1 {
    public static void main(String[] args) {
        ...
        // [******] 다형성 [******]
        // *하나의 자료*가 다양한 행(형식/모양/형태/구분) 성질
        // 1. 참새 타입에서 조류타입 으로 될까?
        // 가능한이유 : (1) 상속관계(논리) (2) 참새인스턴스가 생성될때 조류+동물 인스턴스 생성(믈리)
        ...
        // 3. 동물타입에서 참새타입으로 될꺼?
        // 주의할점: (1) 변환타입명사 (2) 변환할 자료가 변환할 타입을 포함하는지
        참새 sparrow2 = (참새)animal2; // 강제타입변환 /  다운캐스팅(내려가기)

        // 4. 동물타입에서 참새타입으로 될까?
        // 즉 , 자식이 태어날때 부모도 태어나지만 자식은 태어나지 않는다
...
class 조류 extends 동물{ // 하위 클래스명 extends 상위 클래스명 { }
    }
class 참새 extends 조류 { }
