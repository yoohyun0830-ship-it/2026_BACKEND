...
# [1] 교집합
# 주의할 점 : 두 개 이상의 테이블간 데카르트 곱으로 표현
 SELECT * FROM table1 , table2; -- table1(5) * table2(5) => 25개 , 2개 이상 테이블 조회
 ...
 # * 3개 이상 테이블 조인
 -- SELECT * FROM TABLE t1 INNER JOIN table2 t2 ON 조인조건 INNER JOIN table3 t3 ON 조인조건
