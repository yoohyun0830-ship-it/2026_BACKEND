...
public static void main(String[] args) {
    ...
    예시: 제 이름은 홍길동, 나이는 25세, 키는 175.5cm 입니다.*/
    // System.out.printf( "제 이름은 %s , 나이는 %d세 , 키는 %.lfcm 입니다. \n" , name , age2 ,  height );
 ...
 */
    ...
    System.out.printf("%-3s %-5s %-10s", "번호","작성자","방문록" );
    System.out.printf("%-5s %-5s %-10s", num,write,content );
    ...
    */
    ...
    System.out.println("나이를 입력하세요."); int 나이 = scan.nextInt();
   ...
   /*
    ...
    내용: 정말입니다. 다들 동의하시죠?
    */
    System.out.println("게시물 번호 : "); int 게시물번호 = scan.nextInt();
    scan.nextLine(); // nextInt() 3 입력후 엔터(\n) 치면 반환되고 엔터(\n) 유지(남는다) 된다. \n초기화
    System.out.println("게시물 제목 : "); String 제목 = scan.nextLine();
    System.out.println("게시물 내용 : "); String 내용 = scan.nextLine();
    System.out.println();
   ...
   System.out.println("이름 : "); String 이름1 = scan.next();
   System.out.println("나이 : "); int 나이1 = scan.nextInt();
   System.out.println("키 : "); double 키1 = scan.nextDouble();
   System.out.println("프로그래머입니까?(ture/flase) : "); boolean 프로그래머 = scan.nextBoolean();
